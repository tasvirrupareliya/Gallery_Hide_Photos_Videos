package com.gallery.photos.lock.galleryhidephotosvideos.extras;
...
public class ViewToImage {
    ...
    private void saveTheImage(Bitmap finalBitmap, String fileName) {
        ...
        try {
            ...
            out.flush();
            out.close();
            this.filePath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + fileName;
