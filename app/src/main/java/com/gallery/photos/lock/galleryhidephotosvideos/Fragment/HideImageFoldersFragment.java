...
import static com.gallery.photos.lock.galleryhidephotosvideos.Activity.MainActivity.imgUnlock;
import static com.gallery.photos.lock.galleryhidephotosvideos.Activity.MainActivity.imgselectall;
import static com.gallery.photos.lock.galleryhidephotosvideos.Activity.MainActivity.llSelectedOptions;
import static com.gallery.photos.lock.galleryhidephotosvideos.Activity.MainActivity.relSelection;
...
public class HideImageFoldersFragment extends Fragment {
    ...
    private void setview(View view) {
        ...
        if (Utils.getInstance().isPasswordSetupDone(getContext())) {
            ...
            new LargeNativeAds().showListNativeAds(getActivity(), view.findViewById(R.id.nativeAd), view.findViewById(R.id.ad_space));
                ...
                if (isResetPwd) {
                    if (isEnterAgain) {
                        ...
                        if (enterpwd.equals(reenteredPWd)) {
                            ...
                            Utils.getInstance().hidePhotos(list, getActivity(), false, () -> {
    ...
    public class HiddenPhotosAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements StickyHeaders, StickyHeaders.ViewSetup {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (holder instanceof HeaderViewHolder) {
                ...
                /*    if (Application.durations.containsKey(HiddenImages.get(position))) {

                        ((HiddenPhotosAdapter.MyViewHolder) holder).txtVideoTime.setText(Utils.convertMillieToHMmSs(Application.durations.get(HiddenImages.get(position))));
                    } else
                        ((HiddenPhotosAdapter.MyViewHolder) holder).txtVideoTime.setText("" + Utils.getInstance().getvideoDurationForhidden(context, HiddenImages.get(position)));
              */
                }
        ...
        public int getItemViewType(int position) {
            if (HiddenImages.get(position).contains("storage")) {
                return SUB_ITEM;
            } else {
                return HEADER_ITEM;
            }
